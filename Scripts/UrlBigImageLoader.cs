...
namespace UdonLab.UrlLoader
{
    public class UrlBigImageLoader : UdonSharpBehaviour
    {
        ...
        public override void OnStringLoadSuccess(IVRCStringDownload result)
        {
            ...
            {
                Debug.LogWarning($"UdonLab.UrlLoader.UrlBigImageLoader: result is empty.");
                return;
            }
        ...
        {
            isLoaded = true;
            Debug.LogError($"UdonLab.UrlLoader.UrlBigImageLoader: {result.ErrorCode} Could not load {result.Url} : {result.Error}");
        }
